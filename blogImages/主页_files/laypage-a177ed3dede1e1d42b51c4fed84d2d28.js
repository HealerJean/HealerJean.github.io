...
;!function () {
    ...
    f.on = function (a, b, c) {
        ...
        var prevDisabled='';
        //前一个不可选样式;
        if(c.curr == 0||c.curr==1){
            prevDisabled='prevDisabled';
        }else{
            prevClick='data-page';
        }
        if (c.pages = 0 | c.pages, c.curr = 0 | c.curr || 1, c.groups = "groups" in c ? 0 | c.groups : 5, c.first = "first" in c ? c.first : "«", c.last = "last" in c ? c.last : "»", c.prev = "prev" in c ? c.prev : "‹", c.next = "next" in c ? c.next : "›", c.pages < 1)return "";
        for (c.groups > c.pages && (c.groups = c.pages), e.index = Math.ceil((c.curr + (c.groups > 1 && c.groups !== c.pages ? 1 : 0)) / (0 === c.groups ? 1 : c.groups)), e.index > 0 && c.first && 0 !== c.groups && d.push('<a href="javascript:;"  class="laypage_first '+prevDisabled+'" '+prevClick+'="1"  title="&#x9996;&#x9875;">' + c.first + "</a><!--<span>&#x2026;</span>-->"), c.curr > 0 && c.prev && d.push('<a href="javascript:;" class="laypage_prev '+prevDisabled+'" '+prevClick+'="' + (c.curr - 1) + '">' + c.prev + "</a>"), e.poor = Math.floor((c.groups - 1) / 2), e.start = e.index > 1 ? c.curr - e.poor : 1, e.end = e.index > 1 ? function () {
        ...
        return e.flow = !c.prev && 0 === c.groups, (/*c.curr !== c.pages &&*/ c.next || e.flow) && d.push(function () {
            return e.flow && c.curr === c.pages ? '<span class="page_nomore '+nextDisabled+'" title="&#x5DF2;&#x6CA1;&#x6709;&#x66F4;&#x591A;">' + c.next + "</span>" : '<a href="javascript:;" class="laypage_next '+nextDisabled+'" '+nextClick+'="' + (c.curr + 1) + '">' + c.next + "</a>"
        }()), /*c.pages > c.groups && e.end < c.pages &&*/ c.last && 0 !== c.gropups && d.push('<!--<span>&#x2026;</span>--><a href="javascript:;" class="laypage_last '+nextDisabled+'" title="&#x5C3E;&#x9875;"  '+nextClick+'="' + c.pages + '">' + c.last + "</a>"), '<div name="laypage' + a.v + '" class="laypage_main '+nextDisabled+' laypageskin_' + (c.skin ? function (a) {
