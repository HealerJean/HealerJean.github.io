...
public class DateUtils {
    ...
    public static class TimeExtTool {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("TimeExtTool.getFirstTime" + TimeTool.toStr(dateTime));
            System.out.println(TimeTool.toStr(toFirstTime(dateTime, ChronoUnit.MINUTES)));
            System.out.println(TimeTool.toStr(toFirstTime(dateTime, ChronoUnit.HOURS)));
            System.out.println(TimeTool.toStr(toFirstTime(dateTime, ChronoUnit.DAYS)));
            System.out.println(TimeTool.toStr(toFirstTime(dateTime, ChronoUnit.MONTHS)));
            System.out.println(TimeTool.toStr(toFirstTime(dateTime, ChronoUnit.YEARS)));
            System.out.println();
            System.out.println("TimeExtTool.getFirstTime" + TimeTool.toStr(dateTime));
            System.out.println(TimeTool.toStr(dateTime));
            System.out.println(TimeTool.toStr(toEndTime(dateTime, ChronoUnit.MINUTES)));
            System.out.println(TimeTool.toStr(toEndTime(dateTime, ChronoUnit.HOURS)));
            System.out.println(TimeTool.toStr(toEndTime(dateTime, ChronoUnit.DAYS)));
            System.out.println(TimeTool.toStr(toEndTime(dateTime, ChronoUnit.MONTHS)));
            System.out.println(TimeTool.toStr(toEndTime(dateTime, ChronoUnit.YEARS)));
            System.out.println();
            System.out.println("TimeExtTool.minusRoll" + TimeTool.toStr(dateTime));
            System.out.println(TimeTool.toStr(roll(dateTime, ChronoUnit.DAYS, -1)));
            System.out.println();
            System.out.println("TimeExtTool.plusRoll" + TimeTool.toStr(dateTime));
            System.out.println(TimeTool.toStr(roll(dateTime, ChronoUnit.DAYS, 1)));

            System.out.println();
            System.out.println("TimeExtTool.getDates" + TimeTool.toStr(dateTime));
