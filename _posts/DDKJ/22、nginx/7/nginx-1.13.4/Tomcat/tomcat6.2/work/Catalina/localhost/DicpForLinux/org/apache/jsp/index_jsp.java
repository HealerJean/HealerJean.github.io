...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/sysManageAction!showMachineStatus.do\" target=\"navTab\" rel=\"machineStatus\" fresh=\"true\">服务器状态</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"\">WS监控</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payInRequestAction!queryInRequests.do\" target=\"navTab\" rel=\"inRequest\" fresh=\"true\">外部请求日志</a></li><!-- t_ws_in_request -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payOutRequestsAction!queryOutRequests.do\" target=\"navTab\" rel=\"outRequest\" fresh=\"true\">请求外部日志</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payInRequestAction!queryInMessage.do\" target=\"navTab\" rel=\"inMessage\" fresh=\"true\">外部请求消息日志</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payOutRequestsAction!queryOutMessage.do\" target=\"navTab\" rel=\"outMessage\" fresh=\"true\">请求外部消息日志</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/sysManageAction!queryWsdest.do\" target=\"navTab\" rel=\"wSDLConfig\" fresh=\"true\">外部服务配置</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"\">JMS监控</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payLogAction!queryReceMsg.do\" target=\"navTab\" rel=\"jMSMessage\" fresh=\"true\">JMS消息查询（后期）</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payDocInfoAction!queryDocInfo.do\" target=\"navTab\" rel=\"payDoc\" fresh=\"true\">业务单证查询</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"\">回调管理</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/sendInstancesAction!querySendInstances.do\" target=\"navTab\" rel=\"sendInstance\" fresh=\"true\">业务回调日志</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"\">文件接收</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"/dicp/payReceFileAction!selectInfoWithProp.do\" target=\"navTab\" rel=\"receFile\" fresh=\"true\">接收文件查询</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
