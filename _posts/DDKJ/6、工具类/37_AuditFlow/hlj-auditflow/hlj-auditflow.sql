...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='审核记录表';

-- ----------------------------
-- Records of scf_flow_audit_record
-- ----------------------------
BEGIN;
INSERT INTO `scf_flow_audit_record` VALUES (1, '', 'a23f418d2a47479798748455717d849a', 3, 'auditJob', '审核任务', 'auditAJobDeal', '审核任务A处理', 1, '20', 0, '', '2019-08-11 19:55:27', '', '2019-08-11 19:55:27', '2019-08-11 19:55:27');
COMMIT;
...
CREATE TABLE `scf_flow_audit_record_temp` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='审核记录临时表';

-- ----------------------------
-- Records of scf_flow_audit_record_temp
-- ----------------------------
BEGIN;
INSERT INTO `scf_flow_audit_record_temp` VALUES (1, 'a23f418d2a47479798748455717d849a', 3, 'auditJob', '审核任务', 'auditAJobDeal', '', '审核任务A处理', 1, 'ID', 1, '{\"instanceNo\":\"a23f418d2a47479798748455717d849a\",\"nextFlow\":true}', '20', 1, 'healerjean', '2019-08-11 19:55:27', '2019-08-11 19:55:27');
INSERT INTO `scf_flow_audit_record_temp` VALUES (2, 'a23f418d2a47479798748455717d849a', 3, 'auditJob', '审核任务', 'auditAJobDeal', '', '审核任务A处理', 1, 'ID', 2, '{\"instanceNo\":\"a23f418d2a47479798748455717d849a\",\"nextFlow\":true}', '20', 1, 'healerjean', '2019-08-11 19:55:27', '2019-08-11 19:55:27');
INSERT INTO `scf_flow_audit_record_temp` VALUES (3, 'a23f418d2a47479798748455717d849a', 3, 'auditJob', '审核任务', 'auditAJobDeal', '', '审核任务A处理', 1, 'ROLE', 1, '{\"instanceNo\":\"a23f418d2a47479798748455717d849a\",\"nextFlow\":true}', '20', 1, 'healerjean', '2019-08-11 19:55:27', '2019-08-11 19:55:27');
INSERT INTO `scf_flow_audit_record_temp` VALUES (4, 'a23f418d2a47479798748455717d849a', 3, 'auditJob', '审核任务', 'auditAJobDeal', '', '审核任务A处理', 1, 'ROLE', 2, '{\"instanceNo\":\"a23f418d2a47479798748455717d849a\",\"nextFlow\":true}', '20', 1, 'healerjean', '2019-08-11 19:55:27', '2019-08-11 19:55:27');
COMMIT;
...
CREATE TABLE `scf_flow_definition` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='流程定义表';
...
CREATE TABLE `scf_flow_node` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='流程节点表';
...
CREATE TABLE `scf_flow_record` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='流程节点表';
...
INSERT INTO `scf_flow_record` VALUES (8, 'a23f418d2a47479798748455717d849a', 'auditJob', '审核任务', 3, 'auditAJobDeal', '审核任务A处理', '20', 1, 'healerjean', '2019-08-11 19:55:27', '2019-08-11 19:55:27');
COMMIT;
...
CREATE TABLE `scf_sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统模块-菜单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统模块-角色与菜单关系表';
