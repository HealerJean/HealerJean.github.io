...
public final class JsonUtils {
     ...
     */
    public static <T> T jsonToArray(String json, Class<T> c, Class<T> collect) {
     ...
     * @return 对象
     */
    public static <T> T toObjectCollect(String json, TypeReference<T> typeReference) {
        try {
