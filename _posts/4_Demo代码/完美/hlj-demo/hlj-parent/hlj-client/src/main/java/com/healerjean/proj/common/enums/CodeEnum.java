...
public interface CodeEnum {
    ...
    enum ErrorCodeEnum implements CodeEnum {
        ...
        ERROR_CODE_PARAMS_ERROR("1000", "参数错误"),
        ERROR_CODE_BUSINESS_ERROR("2000", "业务处理失败"),
        ERROR_CODE_PRC_ERROR("3000", "RPC处理失败"),
        ERROR_CODE_RUNTIME_ERROR("4000", "运行时失败"),
        ERROR_CODE_FAIL("9999", "系统太火爆了，请稍后重试!"),
        ;
