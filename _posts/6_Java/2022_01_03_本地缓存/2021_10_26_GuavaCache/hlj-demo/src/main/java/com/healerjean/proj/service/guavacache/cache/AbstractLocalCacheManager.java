package com.healerjean.proj.service.guavacache.cache;
...
public abstract class AbstractLocalCacheManager<K, V> {
    ...
    public void refreshAll() {
        ...
        log.info("refreshAll {}, loadAll use time: {}ms , total: {} , stats:{}", this.getClass().getSimpleName(), System.currentTimeMillis() - t1, localCache.size(), localCache.stats().toString());
    }
