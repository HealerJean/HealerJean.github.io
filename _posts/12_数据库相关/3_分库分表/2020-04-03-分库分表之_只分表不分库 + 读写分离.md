---
title: 分库分表之_只分表不分库 + 读写分离
date: 2020-04-03 03:33:00
tags: 
- Database
category: 
- Database
description: 只分库分表之_只分表不分库 + 读写分离
---
...
## 1.1、`hlj-05-sharding_table-read_write.sql`  
...
![1585559965423](https://raw.githubusercontent.com/HealerJean/HealerJean.github.io/master/blogImages/1585559965423.png)
...
spring.shardingsphere.sharding.tables.company.actual-data-nodes=ds0.company_${0..1}
...
> 测试结果是《分库分表之_读写分离》和《分库分表之_只分表不分库》 二者的结合
