...
JOIN (
    SELECT 
        vender_id,
        MAX(modified_time) AS max_modified_time
    FROM table_h
    WHERE rule_no = '504000003'
    GROUP BY vender_id
) latest 
ON t.vender_id = latest.vender_id 
AND t.modified_time = latest.max_modified_time
WHERE t.rule_no = '504000003';
```
