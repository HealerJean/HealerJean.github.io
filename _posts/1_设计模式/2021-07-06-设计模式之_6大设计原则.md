...
![image-20210706205043822](https://raw.githubusercontent.com/HealerJean/HealerJean.github.io/master/blogImages/image-20210706205043822.png)
...
**通俗理解**：**“子类必须能无缝替代父类，不能让调用者‘踩坑’**。子类可以扩展父类的功能，但不能改变父类原有的功能，子类中尽量不要去重写父类方法，`A`类的所有方法都被`B`类重写了。 那何必继承呢？直接新建一个`B`类不就好了，采用 `final` 的手段强制来遵循
...
![image-20210708150714893](https://raw.githubusercontent.com/HealerJean/HealerJean.github.io/master/blogImages/image-20210708150714893.png)
...
![image-20210708151511003](https://raw.githubusercontent.com/HealerJean/HealerJean.github.io/master/blogImages/image-20210708151511003.png)
