...
/**
 * 脱敏 SensitiveParameterFormatter
 *
 * @author zhangyujin
 * @date 2023/6/14  21:24
 */
public class SensitiveParameterFormatter {
    /**
    ...
    private SensitiveParameterFormatter() {
    }
     ...
     * logValueFilter
     */
    private static final LogValueFilter LOG_VALUE_FILTER = new LogValueFilter();
    ...
    private static void tryObjectToString(final Object o, final StringBuilder str) {
        ...
        try {
            str.append(JSON.toJSONString(o, LOG_VALUE_FILTER));
        } catch (final Throwable t) {
            try {
                str.append(o);
            } catch (final Throwable tt) {
                handleErrorInObjectToString(o, str, tt);
            }
