...
public static <Q, R> List<R> queryAll(BiFunction<Page<R>, Q, IPage<R>> function,
  ...
  public static <Q, R> List<Future<List<R>>> queryAll(ExecutorService executorService, 
...
List<SystemHelpDoc> list =  MybatisPlusQueryUtils.queryAll((p, q) -> systemHelpDocDao.page(p, q), 
                                                     queryWrapper,
                                                    1000);
