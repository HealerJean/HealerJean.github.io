...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
     ...
     * @return 结果
     * 例: DateUtils.rollDate(new Date(),Calendar.DATE,-12); 当前日期的前12天
     * 例: DateUtils.rollDate(new Date(),Calendar.MONTH,2);  向后滚动两个月
     */
    ...
    public static Long getDistanceDays(Date one, Date two) {
        one = DateUtils.getDateFirstTime(one, Calendar.DATE);
        two = DateUtils.getDateFirstTime(two, Calendar.DATE);
        long days = 0;
