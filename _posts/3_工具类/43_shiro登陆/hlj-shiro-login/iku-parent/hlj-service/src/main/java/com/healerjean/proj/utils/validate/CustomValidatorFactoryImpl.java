...
import com.healerjean.proj.utils.validate.validator.*;
import com.healerjean.proj.validate.anno.*;
...
public class CustomValidatorFactoryImpl implements HibernateValidatorFactory {
    ...
    public CustomValidatorFactoryImpl(ConfigurationState configurationState) {
        ...
        constraintList = new ArrayList<>(1);
        constraintList.add(DictionaryIncludeValidator.class);
        constraintHelper.addConstraintValidatorDefinition(DictionaryInclude.class, constraintList);
        constraintList = new ArrayList<>(1);
