...
public List<Person> queryPerson(List<String> userIds) {
  ...
  try {
    response = userServiceThrift.queryPerson(userIds);
  }  catch (Exception e) {
    log.error("[UserService#queryPerson] error, userIds:{}, e:{} ", 
              JsonUtils.toJsonString(userIds), ExceptionUtils.getStackTrace(e));
    throw new ApiException(ErrorCodeEnum.ERROR_CODE_1009.getCode(), e.getMessage());
  }
  ...
  throw new ApiDataException(ErrorCodeEnum.ERROR_CODE_1008.getCode(), signInsuranceInfoQueryRes.getResultMsg());
}
...
public class LogAspect {
    ...
    public Object printLog(final ProceedingJoinPoint pjp, LogIndex logIndex) throws Throwable {
        ...
        try {
            ...
            map.put("requestParams", getRequestParams(args));
    ...
    public List<Object> getRequestParams(Object[] args){
