...
/**
    ...
    public FilterRegistrationBean authenticationFilter() {
        ...
        filterRegistration.addUrlPatterns("/*");
        filterRegistration.addInitParameter("ignorePattern","/templet*|/custom*|/api*|/register*|/fan*|/error|/public*" +
                "|/apps/docked*|/play/docked*|/apps/deeplink*|/assets*|/ftl*|/partner*|/workflow/ding*|duodian/youhui/*|duodian/swagger/index.html/*|swagger*|duodian/invalidate*|duodian/public/nopermission*|duodian/coupon/upload*|duodian/taokeData/uploadExcel*");
