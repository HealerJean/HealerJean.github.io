...
public class GsonUtil {
    ...
    static {
        ...
        gb.registerTypeAdapter(java.util.Date.class, new DateDeserializer()).setDateFormat(DateFormat.LONG);gb.disableHtmlEscaping();
        gb.disableHtmlEscaping(); // 防止= 等特殊字符变成玩过吗Uniencode
        gson = gb.create();
