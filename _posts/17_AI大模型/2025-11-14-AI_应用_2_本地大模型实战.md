---
title: AI_应用_2_本地大模型实战
date: 2025-11-14 00:00:00
tags:
- AI
category:
- AI
description: 本地大模型实战：Ollama部署、RAG文档问答、LangChain链式调用、工具集成、Agent自主决策、流式输出、模型微调
---
...
# 十、不用`LangChain` 也可函数：`Function Calling`
