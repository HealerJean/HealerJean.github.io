...
> Set的底层实现是**「`ht `和`intset`」**，`ht`（哈希表）前面已经详细了解过，下面我们来看看inset类型的存储结构。
...
![image-20210531190854474](https://raw.githubusercontent.com/HealerJean/HealerJean.github.io/master/blogImages/image-20210531190854474.png)
